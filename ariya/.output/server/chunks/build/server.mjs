...
import { p as parseURL, e as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, l as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, i as createError$1, v as executeAsync, x as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "games-dat-tin",
    path: "/games/dat-tin",
    component: () => import('./dat-tin-Dh6mCctD.mjs')
  },
  {
    name: "games-imposter",
    path: "/games/imposter",
    component: () => import('./imposter-Dt2lK7S7.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-paPFuBGL.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CKw5DfbN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BcQk5kP2.mjs'));
